...
git clone https://github.com/Rikabi/Mmed_98-bot.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf superflux-bot && rm -rf .telegram-cli && git clone https://github.com/Rikabi/Mmed_98-bot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
